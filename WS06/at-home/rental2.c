      ...
      case 2: // Calculate Rental Charges
         ...
         if (flag != -1) {
            ...
            */
            ...
            printf("====== ====== ========== ======\n");
			printf("%6.2lf %6.2lf %10c %6.2lf\n\n", basePrice, rate, answer, vRent[flag].earnings);
            // Use "%6.2lf %6.2lf %10c %6.2lf" formatting inside a printf statemen
...
/* Implement Function substractPositive Here */
